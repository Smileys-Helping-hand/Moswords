  ...
  return (
    <div className="flex flex-col h-[calc(100dvh-4rem)] md:h-screen min-h-0 bg-background">
      ...
      <div className="flex-1 p-4 space-y-3 overflow-hidden">
        {[120, 80, 200, 60, 160, 100, 140, 80, 180].map((w, i) => (
          <div key={i} className={`flex items-end gap-2 ${i % 4 !== 0 ? 'flex-row-reverse' : ''}`}>
            {i % 4 === 0 && <div className="skeleton w-8 h-8 rounded-full shrink-0" />}
